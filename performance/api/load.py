...
endpoints = [
    ...
    {"path": "/nodes/123", "method": "PUT", "body": {"type":"test","properties": {"updated": True}}},
    {"path": "/nodes/456", "method": "PUT", "body": {"type":"test","properties": {"updated": True}}},
    {"path": "/edges", "method": "GET"},
    {"path": "/edges", "method": "POST", "body": {"from_node": "123", "to_node": "456", "relationship_type": "TEST_RELATION","properties":{"since":"1971"}}},
    {"path": "/query", "method": "POST", "body": {"node_type": "test", "limit": 5}},
    {"path": "/traverse", "method": "POST", "body": {"start_node": "123", "relationship_type": "TEST_RELATION", "max_depth": 2}},
